        ...
        <div class="glass-effect rounded-2xl p-8 shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            <div class="text-center">
                <div class="mb-6 floating" data-aos="zoom-in" data-aos-delay="200">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/server-error-500-10516500-8503824.png"
                         alt="500 Internal Server Error" class="w-48 h-48 mx-auto">
                </div>
                ...
                <p class="text-gray-600 mb-8" data-aos="fade-up" data-aos-delay="600">
                    Terjadi kesalahan di sisi server. Silakan coba beberapa saat lagi atau hubungi administrator.
                </p>

                <a href="{{ url('/') }}"
                   class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#6b21a8] to-[#3b0764] text-white font-semibold rounded-lg shadow-lg hover:from-[#3b0764] hover:to-[#6b21a8] transition duration-300 ease-in-out transform hover:scale-105"
