    ...
    <div class="col-lg-4 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <x-input-with-icon-label label="Domain WA Gateway (contoh: wagateway.puskesmasbalaraja.com)" name="domain_wa_gateway" icon="ti ti-mail" :value="$setting->domain_wa_gateway ?? ''" />
